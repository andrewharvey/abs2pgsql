...
WITH selection AS (
  SELECT
    ...
    total_dwellings,
    value_of_new_houses,
    value_of_new_other_residential_building,
    value_of_alterations_and_additions_to_residential_buildings,
    value_of_total_residential_building,
    value_of_nonresidential_building,
